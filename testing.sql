...
-- Dumping structure for table testing.failed_jobs
...
-- Dumping structure for table testing.namas
CREATE TABLE IF NOT EXISTS `namas` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
-- Dumping structure for table testing.personal_access_tokens
